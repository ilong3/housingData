...
class BasicCrawler {
    ...
    constructor(options = {}, config = core_1.Configuration.getGlobalConfig()) {
        ...
        handleRequestFunction, requestHandler, handleRequestTimeoutSecs, requestHandlerTimeoutSecs, errorHandler, handleFailedRequestFunction, failedRequestHandler, statusMessageLoggingInterval = 10, statusMessageCallback, statisticsOptions, } = options;
        ...
        const crawlingContext = {
            ...
            sendRequest: async (overrideOptions) => {
                ...
                return (0, utils_1.gotScraping)({
                    url: request.url,
                    method: request.method, // Narrow type to omit CONNECT
                    body: request.payload,
                    headers: request.headers,
