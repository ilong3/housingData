import type { RestrictedCrawlingContext, StatisticState, StatisticsOptions, GetUserDataFromRequest, RouterRoutes } from '@crawlee/core';
...
export declare function createAdaptivePlaywrightRouter<Context extends AdaptivePlaywrightCrawlerContext = AdaptivePlaywrightCrawlerContext, UserData extends Dictionary = GetUserDataFromRequest<Context['request']>>(routes?: RouterRoutes<Context, UserData>): import("@crawlee/browser").RouterHandler<Context>;
export {};
